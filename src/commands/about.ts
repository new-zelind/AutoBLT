    ...
    exec(message){
        const embed = makeEmbed(message)
            ...
            .addFields(
                ...
                {
                    name: "Anthing else?",
                    value: "Yes! I have two brothers, Vexbot and ByrnesBot. I am the youngest; my oldest brother, Vexbot, was made solely by Brendan for the VEX Robotics Teams of South Carolina Discord server. ByrnesBot was made by Zach and Brendan for Zach's Floor Discords. (They're great, but kinda annoying if you ask me.)"
                }
            );

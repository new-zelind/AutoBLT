...
module.exports = {
    ...
    execute(msg, args){
        const embed = new MessageEmbed()
            ...
            .setURL('https://www.clemson.edu/registrar/academic-calendars/calendars.html?year=2020&semester=fall')
            ...
            .addFields(
                ...
                { name: 'September 1',      value: 'Last day to drop a class without a \'W\''},
                { name: 'September 8',      value: 'December Graduation Applications Due'},
                { name: 'October 9',        value: 'Midterm Evaluations Due'},
                { name: 'October 23',       value: 'Last day to drop a class without a final grade'},
